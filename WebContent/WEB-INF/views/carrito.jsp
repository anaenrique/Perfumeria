...
<body>
  ...
  <div class="slider-area ">
    <!-- Mobile Menu -->
    <div class="single-slider slider-height2 d-flex align-items-center" data-background="/Perfumeria/resources/assets/img/hero/carritoCompra.jpg">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
      ...
      <div class="cart_inner">
        <div class="table-responsive">
              ...
              <tr>
                ...
                <td>
                  <div class="product_count">
                    <span class="input-number-decrement" name="total" value=""> <i class="ti-minus"></i></span>
                ...
                <td>
                	<a href="/Perfumeria/quitarCarrito/${index.index}" class="btn btn-danger" >Eliminar</a>
                </c:forEach>
                </td>
          ...
          <div class="checkout_btn_inner float-right">
            ...
            <a class="btn_1 checkout_btn_1" href="#" style="background-color: #800080; color:white;">PROCEDER AL PAGO</a>
          </div>
        </div>
        </div>
        </c:if>
